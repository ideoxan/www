...
export default function LogIn() {
    ...
    return (
        <AuthSplash>
            ...
            <h1 className="section-header mx-auto font-sans font-extrabold tracking-tight text-center text-2xl text-transparent bg-gradient-white bg-clip-text">Log into an existing account</h1>
