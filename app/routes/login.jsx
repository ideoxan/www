...
export default function LogIn() {
    ...
    return (
        <AuthSplash>
            <h1 className="section-header mx-auto font-sans font-extrabold tracking-tight text-center text-2xl text-transparent bg-gradient-white bg-clip-text">
            ...
            <Form method="post" autoComplete="off" className="mt-6 flex flex-col w-full">
                ...
                <div className="w-full flex flex-row mt-6">
                    <a
                        href="/resetpassword"
                        className="mr-auto mb-auto font-sans font-medium text-center text-2xs text-gray-50 opacity-50 hover:underline"
                    >
                        Reset Password
                    </a>
