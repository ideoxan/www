...
export default function CoursesSection() {
    let sampleCourseData = [
        {
            title: 'Intro to HTML',
            description: 'Learn the basics of what makes up the world wide web in this introductory course.',
            infoURL: '/courses/#abc123-xyz456-7890',
            startURL: '/learn/abc123-xyz456-7890/1/1',
        },
        {
            title: 'Intro to CSS',
            description: 'CSS allows for any HTML document to be stylized and formatted. In this course you will learn the basics of CSS and be able to apply styles to HTML documents.',
            infoURL: '/courses/#abc123-xyz456-7890',
            startURL: '/learn/abc123-xyz456-7890/1/1'
        },
        {
            ...
            description: 'NodeJS is the runtime built on top of the v8 engine that allows for JavaScript to be run in desktop and server environments.',
            infoURL: '/courses/#abc123-xyz456-7890',
            startURL: '/learn/abc123-xyz456-7890/1/1',
            comingSoon: true,
        },
        {
            className: 'hidden sm:flex md:hidden lg:flex',
            title: 'Intro to C',
            description: 'C is a general purpose programming language invented in 1970 by Dennis Ritchie. Despite its age, today C is still just as powerful as it is popular.',
            infoURL: '/courses/#abc123-xyz456-7890',
            startURL: '/learn/abc123-xyz456-7890/1/1',
            comingSoon: true,
        }
