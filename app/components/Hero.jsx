        ...
        <FadeInSection>
            <header
                ...
                <div className="flex flex-col mt-8 lg:mt-32 mb-0 md:mb-10 lg:mb-8 md:mx-auto max-w-3xl lg:max-w-7xl lg:w-full p-8">
                    ...
                    <h2 className="sm:mx-auto mt-8 font-sans font-semibold tracking-tight text-sm sm:text-base md:text-lg max-w-sm sm:max-w-md md:max-w-full sm:text-center text-gray-50 opacity-80">
